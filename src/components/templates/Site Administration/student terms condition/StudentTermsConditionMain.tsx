...
import { StudentTermsConditionAdd } from "./StudentTermsConditionAdd";
...
///
export const StudentTermsConditionMain = ({
  title,
  setModel,
  resetForm,
  updateData,
  ...
  const { mutate, isLoading } = useMutate({
    mutationKey: ["dashboard/students-terms-conditions"],
    endpoint: `dashboard/students-terms-conditions`,
  ...
  const { mutate: update, isLoading: LoadingUpdateSponsor } = useMutate({
    mutationKey: ["dashboard/students-terms-conditions"],
    endpoint: `dashboard/students-terms-conditions/${updateData?.id}`,
    onSuccess: (data: InitialValues_TP) => {
      refetch()
      notify("success");
      setModel(false);
