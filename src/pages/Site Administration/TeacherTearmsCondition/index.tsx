...
import { TeacherTermsConditionMain } from "../../../components/templates/Site Administration/TeacherTearmsCondition/TeacherTermsConditionMain";
...
type TeacherTermsCondition_props = {
  title: string;
  dataSource?: any;
  TeacherTermsConditionData?: any;
  setModel?: any;
  resetForm?: any;
};

export type TeacherTermsConditionData = {
  id: number;
  text: string;
  text_ar: string;
  text_en: string;
...
export const TeacherTermsCondition = ({
  title,
}: TeacherTermsCondition_props) => {
  ...
  const cols = useMemo<ColumnDef<TeacherTermsConditionData>[]>(
    () => [
      {
        header: "#",
  ...
  const endpoint = `dashboard/teachers-terms-conditions?${searchParams.toString()}`;

  const {
    isSuccess,
    refetch,
    data: TeacherTermsConditionData,
    isFetching,
    isRefetching,
  ...
  const deleteEndPoint = `dashboard/teachers-terms-conditions/${conditionId}`;
      ...
      <div className="bg-white p-2 md:p-8 rounded-xl dark:bg-dark-tertiary">
        <div className="grid grid-cols-12">
          <div className="col-span-12 ">
            ...
            <Table
              data={
                TeacherTermsConditionData?.data?.items
                  ? TeacherTermsConditionData?.data?.items
                  : []
              }
              showNavigation
            ...
            <div className="flex justify-end mt-3">
              <Paginate
                pagesCount={
                  TeacherTermsConditionData?.data?.paginate.total_pages
                }
