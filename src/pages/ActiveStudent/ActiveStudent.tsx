...
type ActiveStudent_TP = {
  title: string;
};

function ActiveStudent({ title }: ActiveStudent_TP) {
  ...
  const cols = useMemo<ColumnDef<ActiveStudent>[]>(
    () => [
      {
        header: "ID",
      ...
      },
      {
        ...
        cell: (info) => (
          <div className="flex gap-2 justify-evenly">
            ...
            <a
              className="bg-[#000]  p-2 rounded-md text-white"
  ...
  console.log("🚀 ~ ActiveStudent ~ AllStudent:", AllStudent);
